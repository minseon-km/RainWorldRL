...
Rain World는 https://store.steampowered.com/app/312520/Rain_World/ 에서 구매할 수 있는 어드벤처 게임이다. 아레나 모드를 활용해, 두 적과 플레이어가 존재하는 환경을 구축해 플레이어가 최대한 오래 생존하는 것을 강화학습의 목적으로 하였다. Rain World를 실행해, 강화학습 코드와 직접 상호작용하며 학습되고 시뮬레이션된다.
